...
-Wertverbesserung: Name: , Betrag für leerstellen (falls kein spezielle Bezeichnung dann Wertverbesserung)
...
ALIASES: Dict[str, Tuple[str, ...]] = {
    ...
    "WIEDERBESCHAFFUNGSAUFWAND": (
        "WIEDERBESCHAFFUNGSWERTAUFWAND",
        "WIEDERBESCHAFFUNGSWERTAUWAND",  # 🔥 dein Fehler abgefangen
    ),
    "WIEDERBESCHAFFUNGSWERTAUFWAND": (
        "WIEDERBESCHAFFUNGSAUFWAND",
        "WIEDERBESCHAFFUNGSWERTAUWAND",
    ),
}
